...
public class FabelAdapter extends FirebaseRecyclerAdapter<Book,FabelAdapter.FavouriteViewHolder> {
     ...
     * @param options
     */
    public FabelAdapter(@NonNull FirebaseRecyclerOptions<Book>options) {
        super(options);
    }
