...
public class MyFavouriteAdapter extends FirebaseRecyclerAdapter<Book,MyFavouriteAdapter.FavouriteViewHolder> {
     ...
     * @param options
     */
    public MyFavouriteAdapter(@NonNull FirebaseRecyclerOptions<Book>options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull FavouriteViewHolder holder, int position, @NonNull Book model) {
        ...
        if(model.getIsFavourite() == 1){
            ...
            System.out.println("hasilFavo"+model.getIsFavourite());
