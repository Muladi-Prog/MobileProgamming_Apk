...
public class LegendaAdapter extends FirebaseRecyclerAdapter<Book,LegendaAdapter.FavouriteViewHolder> {
     ...
     * @param options
     */
    public LegendaAdapter(@NonNull FirebaseRecyclerOptions<Book>options) {
        super(options);
    }
